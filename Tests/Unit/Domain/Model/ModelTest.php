...
/**
 * Test case for class \Comuno\Nodedb2\Domain\Model\Model.
 *
 * @version $Id$
 ...
 */
class ModelTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \Comuno\Nodedb2\Domain\Model\Model
	 */
	protected $subject;

	public function setUp() {
		$this->subject = new \Comuno\Nodedb2\Domain\Model\Model();
	}
